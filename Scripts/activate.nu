...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\Pc\Documents\Study\MST\S1\python\practice\ML-Prediction'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\Pc\Documents\Study\MST\S1\python\practice\ML-Prediction\Scripts\deactivate.nu'
